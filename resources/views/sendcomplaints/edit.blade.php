...
@section('content')
    ...
    <form action="{{ route('sendcomplaints.update',$complaint->id) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <input type="hidden" name="customer_id" value="{{ $complaint->customer_id }}">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal" value="{{ $complaint->tanggal }}">
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" id="" cols="30" rows="10">{{ $complaint->keterangan }}</textarea>
            </div>
            <div class="form-group">
